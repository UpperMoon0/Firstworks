...
Vanilla copper smelting and blasting recipes for raw copper, copper ore, and deepslate copper ore are removed on datapack sync. Pack-authored recipes under other IDs remain available. The mortar and pestle grinds one brick into one grog before copper is available (40 ticks). The quern requires copper fasteners and upgrades the yield to two grog per brick. The stone hammer uses a stone head, strong binding, and stick handle.
