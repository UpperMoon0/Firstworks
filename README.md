...
- **KubeJS**: Custom wood registration, custom recipes, and cancellable process-start/completion lifecycle hooks including `workshopProcessingStarting` / `workshopProcessingCompleted`.
