...
/** Public integration tags for Firstworks tool roles and low-tech progression materials. */
public final class ModTags {
    public static final TagKey<Item> PRIMITIVE_KNIVES = TagKey.create(Registries.ITEM, Firstworks.id("primitive_knives"));
    ...
    public static final TagKey<EntityType<?>> LEATHER_DROPS_AS_RAW_HIDE = TagKey.create(Registries.ENTITY_TYPE, Firstworks.id("leather_drops_as_raw_hide"));
    public static final TagKey<EntityType<?>> NO_RAW_HIDE_DROPS = TagKey.create(Registries.ENTITY_TYPE, Firstworks.id("no_raw_hide_drops"));
    public static final TagKey<Block> BARRELS_BLOCK = TagKey.create(Registries.BLOCK, Firstworks.id("barrels"));
    public static final TagKey<Item> BARRELS_ITEM = TagKey.create(Registries.ITEM, Firstworks.id("barrels"));
    public static final TagKey<Block> LOOMS_BLOCK = TagKey.create(Registries.BLOCK, Firstworks.id("looms"));
    public static final TagKey<Item> LOOMS_ITEM = TagKey.create(Registries.ITEM, Firstworks.id("looms"));
    public static final TagKey<Item> RAW_HIDES = TagKey.create(Registries.ITEM, Firstworks.id("raw_hides"));
    public static final TagKey<Block> OCHRE_SOURCES = TagKey.create(Registries.BLOCK, Firstworks.id("ochre_sources"));
    public static final TagKey<Block> PLANT_FIBRE_SOURCES = TagKey.create(Registries.BLOCK, Firstworks.id("plant_fibre_sources"));
    public static final TagKey<Block> DOUBLE_PLANT_FIBRE_SOURCES = TagKey.create(Registries.BLOCK, Firstworks.id("double_plant_fibre_sources"));
    private ModTags() {}
}
